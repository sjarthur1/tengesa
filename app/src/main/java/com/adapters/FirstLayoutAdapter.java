...
public class FirstLayoutAdapter extends RecyclerView.Adapter<FirstLayoutAdapter.FirstLayourViewHolder> {
    ...
    public FirstLayoutAdapter( Context context, List<ProductData> itemList, FragmentManager fragmentManager ){
    ...
    @NonNull
    @Override
    public FirstLayourViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new FirstLayourViewHolder( LayoutInflater.from( context ).inflate( R.layout.layout_one_adapter_item, parent, false ) );
    }
    ...
    public class FirstLayourViewHolder extends RecyclerView.ViewHolder{
        ImageView imageViewItemImage, imageViewLike;
        TextView textViewGadget, textViewPrice, textViewCurrency;
        Button buttonAddToCart;
    
        public FirstLayourViewHolder(@NonNull View itemView) {
            super(itemView);
